...
<?php 
  ...
  $nameSurname = $hospitalName = $birtday = 
  $passportNo = $country = $gender = 
  $phone = $email = $heavy = $height = 
  $episode = $entryDate = $endDate = 
  $protocolNo = $description = $situation = 
  $job = $currency = $price = 
  $attendantNameSurname = $attendantBirtday = 
  ...
  if(isset($_POST["addPatient"])){
    ...
    if(empty($error)){
      if($patients->addPatient($nameSurname,$hospitalName,
  ...
  <div class="admin-dashboard w-100">
    ...
    <div class="bg-secondary h-100 py-5">
      <div class="container">
        ...
        <div class="card">
          <div class="card-body">
            <h3 class="text-center">Hasta Ekle</h3>
            ...
            <form method="POST">
              ...
              <div>
                <div class="d-flex flex-wrap gap-md-5 gap-sm-3">
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" name="situation" aria-label="Default select example">
                      ...
                      <option value="Giriş yapacak">Giriş yapacak</option>
                      <option value="Tedavisi devam ediyor">Tedavisi devam ediyor</option>
                      <option value="Ayakta tedavi oldu">Ayakta tedavi oldu</option>
                      <option value="Çıkış yapacak">Çıkış yapacak</option>
                    </select>
                  </div>
                  <div class="mb-3">
                ...
                <button type="submit" name="addPatient" class="btn btn-primary">Ekle</button>
              </div>
